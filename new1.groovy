...
def emailNotification(buildstatus,sysdate,relnum,TCresult){
    ...
    if("${buildstatus}"=='Succeeded'){
      ...
      // recipentlist="amar.khan@i-exceed.com" 
       ...
       emailBody= """<p style="color:red;">Hi All, <br><br> AppzillonStudio-3.6.0 Build with Automation Testing ${buildstatus}: Job ${env.JOB_NAME} [${env.BUILD_NUMBER}] <br><br> Check console output at <a href='${env.BUILD_URL}'>${env.JOB_NAME} [${env.BUILD_NUMBER}]</a><br><br>Regards,<br><br>Appzillon IDE Team<br>I-Exceed Technology Solutions</p>"""
    }
    emailext (
